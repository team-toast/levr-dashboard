        ...
        convertTo(
            ...
            ? parseFloat(
                  curveData.tokensReceived /
                      (STATIC_MAX_TOKENS -
                          (curveData.totalTokensSoldBefore +
                              curveData.tokensReceived))
              ).toFixed(4) * fit_in
            : parseFloat(
                  curveData.totalTokensSoldBefore / STATIC_MAX_TOKENS
              ).toFixed(4) * fit_in;
    let bottomPosition =
        parseFloat(
            (curveData.totalTokensSoldBefore + curveData.tokensReceived) /
        ...
        <CurveBox>
            ...
            <Col size={1}>{((curveData.maxPrice / 5) * 1).toFixed(6)}</Col> */}
                ...
                <Col size={1}>
                    ...
                    <Supply>
                        <Row>
                            ...
                            <Col size={1}>
                                {(400 / 4 / zoomLevel).toFixed()}M
                            </Col>
                            <Col size={1}>
                                {(((400 / 4) * 2) / zoomLevel).toFixed()}M
                            </Col>
                            <Col size={1}>
                                {(((400 / 4) * 3) / zoomLevel).toFixed()}M
                            </Col>
                            <Col size={"0 0 auto"}>
                                {(400 / zoomLevel).toFixed()}M{" "}
                                {zoomLevel == 1 ? "" : " ..."}
                            </Col>
                        </Row>
                    </Supply>
                ...
                <Col className="text-center hide-xs">
                    ...
                    > */}
                    <RangeSliderBox className={steps_to_use * 2 >= 2 ? "" : ""}>
                        <RangeSlider
