            ...
            <Row>
                ...
                >
                    <Row xsNoflex>
                        <Col size={1}>
                            <Link href="/">
                                <a className="menu-item-links padding-r-1">
                                    Home
                                </a>
                            </Link>
                        ...
                        <Col size={"0 0 auto"} className="text-right">
                            <SocialCol
                                className={
                                    toggleMobileMenu ? "show-menu-item" : ""
                                }
                                size={`0 0 auto`}
                            >
                                <a
                                ...
                                >
                                    <img
                                        src="/Icon awesome-telegram-plane.svg"
                                        height="21"
                                    />
                                </a>
                            </SocialCol>
                        ...
                        {!noWeb3 && (
                            <Col size={"0 0 auto"} className="text-right">
                                <CurrencyToggel
                                    ...
                                    onClick={() =>
                                        setShowUSDCurrency(!showUSDCurrency)
                                    }
                                >
                                    <div>µEth</div>
                                    <div>USD</div>
