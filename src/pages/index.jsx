...
export default function Home({ ethPrice }) {
    ...
    const fetchSaleData = async (amount) => {
        try {
            ...
            const saleInfo = await new_contract.methods
                .getSaleInfo(amount)
                .call();
            setCurveData({
                ...
                raisedBefore: parseFloat(
                    web3?.utils?.fromWei(
                        saleInfo._raisedBefore.toString(),
                        "ether"
                    )
                ),
                ...
                raisedAfter: parseFloat(
                    web3?.utils?.fromWei(
                        saleInfo._raisedAfter.toString(),
                        "ether"
                    )
                ),
                ...
                tokensReceived: parseFloat(
                    web3?.utils?.fromWei(
                        saleInfo._tokensReceived.toString(),
                        "ether"
                    )
                ),
    ...
    const convertTo = (value, data) => {
        const convert = parseFloat(
            web3?.utils?.fromWei(value.toString(), data)
        );
        return convert;
    };
    return (
